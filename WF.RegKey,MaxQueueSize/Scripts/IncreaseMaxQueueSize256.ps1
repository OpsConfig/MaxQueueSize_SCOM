...
Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\services\HealthService\Parameters\Management Groups\$Name" -Name 'maximumQueueSizeKb' -Value 262144 -Force
}
